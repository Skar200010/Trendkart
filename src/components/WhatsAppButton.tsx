...
export default function WhatsAppButton({ phoneNumber = '7045878466' }: WhatsAppButtonProps) {
  ...
  return (
    <motion.button
      ...
      whileTap={{ scale: 0.95 }}
      className="fixed bottom-6 right-6 z-50 bg-green-500 hover:bg-green-600 text-white p-4 rounded-full shadow-2xl hover:shadow-green-500/30 transition-all duration-300"
