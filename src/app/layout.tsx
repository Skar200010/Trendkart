...
export const metadata: Metadata = {
  title: {
    default: "TrendKartEasy - Your Fashion Destination",
    template: "%s | TrendKartEasy",
  },
  description: "Discover the latest trends in men's and women's fashion. Shop trending styles, compare prices, and find the best deals on TrendKartEasy.",
  keywords: ["fashion", "clothing", "men's fashion", "women's fashion", "shopping", "trendy", "online shopping"],
  authors: [{ name: "TrendKartEasy" }],
  creator: "TrendKartEasy",
  publisher: "TrendKartEasy",
  metadataBase: new URL("https://trendkart.com"),
  openGraph: {
    type: "website",
    locale: "en_US",
    url: "https://trendkart.com",
    siteName: "TrendKartEasy",
    title: "TrendKartEasy - Your Fashion Destination",
